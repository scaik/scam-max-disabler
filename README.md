...
## Что вы получите
- Сделаете вид, что Max не запускается/падает — не работает на вашем устройстве. Модуль магиск полностью делает запуск Max невозможным
- Без рута, без удаления приложений, без сложной настройки. Модуль магиск требует рут.
...
1) Скачиваете модуль
2) Заходите в магиск
3) Ставите модуль и перезагрузжайтесь
4) Запускаете Max - нужный результат в кармане.

# Касаемо приложения скаМ
